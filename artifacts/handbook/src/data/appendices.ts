...
export const appendices: Appendix[] = [
  ...
  { id: "a25", number: 25, title: "Sample Annual Calendar and Key Dates", category: "Planning & Templates", description: "Template annual calendar with key dates, competition windows, and planning milestones.", filename: "appendix-25-annual-calendar.pdf" },
  { id: "a26", number: 26, title: "Sample Annual Plan — Overview", category: "Planning & Templates", description: "One-page overview template for seasonal planning with coaching goals and competition calendar.", filename: "appendix-26-annual-plan-overview.pdf" },
  { id: "a27", number: 27, title: "Sample Session Breakdown Template", category: "Planning & Templates", description: "Session breakdown template with warm-up, main activity, and cool-down structure with timing.", filename: "appendix-27-session-breakdown-template.pdf" },
  { id: "a28", number: 28, title: "Sample Session Planner", category: "Planning & Templates", description: "Blank session planner template for weekly coaching session preparation.", filename: "appendix-28-session-planner.pdf" },
  { id: "a29", number: 29, title: "Sample Six-Week Development Block", category: "Planning & Templates", description: "Template for planning a six-week coaching development block aligned to LTAD principles.", filename: "appendix-29-six-week-block.pdf" },
  { id: "a30", number: 30, title: "Session Planner Guideline with Durations", category: "Planning & Templates", description: "Session planner guideline with recommended time allocations for each phase at different age groups.", filename: "appendix-30-session-planner-durations.pdf" },
  { id: "a31", number: 31, title: "St Pats — Sample Session Planner (Editable)", category: "Planning & Templates", description: "Editable session planner in St Pats format for planning and recording weekly training sessions.", filename: "appendix-31-stpats-session-planner-editable.pdf" },
  { id: "a32", number: 32, title: "St Pats Donabate Football Workshop — Coaching Core Skills", category: "Coaching Resources", description: "Materials from the St Pats football coaching workshop covering the core skills framework.", filename: "appendix-32-football-workshop-core-skills.pdf" },
  { id: "a33", number: 33, title: "St Pats GAA Juvenile Playing Policy — Age", category: "Club Policies", description: "St Pats official policy on playing within age groups including guidelines for playing up.", filename: "appendix-33-playing-policy-age.pdf" },
  { id: "a34", number: 34, title: "St Pats Nursery Programme Mentor Summary", category: "Coaching Resources", description: "Summary of the St Pats Nursery Programme covering structure, philosophy, and mentor guidance.", filename: "appendix-34-nursery-programme-summary.pdf" },
  { id: "a35", number: 35, title: "St Pats Player Skills Chart — Football and Hurling", category: "Player Development", description: "Player skills assessment chart for football and hurling covering all juvenile age groups.", filename: "appendix-35-skills-chart-football-hurling.pdf" },
  { id: "a36", number: 36, title: "St Pats Skills Chart — Camogie", category: "Player Development", description: "Player skills assessment chart for camogie covering stick skills and game skills benchmarks.", filename: "appendix-36-skills-chart-camogie.pdf" },
  { id: "a37", number: 37, title: "St Pats Skills Chart — LGFA", category: "Player Development", description: "Player skills assessment chart for ladies football aligned to LGFA development guidelines.", filename: "appendix-37-skills-chart-lgfa.pdf" },
  { id: "a38", number: 38, title: "Team Parent Meeting Template", category: "Planning & Templates", description: "Agenda template for the annual team parent meeting covering season overview and expectations.", filename: "appendix-38-team-parent-meeting.pdf" }
];
